...
const AP_Param::GroupInfo AP_MotorsHeli::var_info[] = {
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("RSC_THRCRV_0", 20, AP_MotorsHeli, _rsc_thrcrv_0, AP_MOTORS_HELI_RSC_THRCRV_0_DEFAULT),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("RSC_THRCRV_25", 21, AP_MotorsHeli, _rsc_thrcrv_25, AP_MOTORS_HELI_RSC_THRCRV_25_DEFAULT),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("RSC_THRCRV_50", 22, AP_MotorsHeli, _rsc_thrcrv_50, AP_MOTORS_HELI_RSC_THRCRV_50_DEFAULT),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("RSC_THRCRV_75", 23, AP_MotorsHeli, _rsc_thrcrv_75, AP_MOTORS_HELI_RSC_THRCRV_75_DEFAULT),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("RSC_THRCRV_100", 24, AP_MotorsHeli, _rsc_thrcrv_100, AP_MOTORS_HELI_RSC_THRCRV_100_DEFAULT),
