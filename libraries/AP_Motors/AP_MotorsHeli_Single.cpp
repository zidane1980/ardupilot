...
void AP_MotorsHeli_Single::calculate_armed_scalars()
{
    ...
    _main_rotor.set_throttle_curve(_rsc_thrcrv_0/1000.0f, _rsc_thrcrv_25/1000.0f, _rsc_thrcrv_50/1000.0f, _rsc_thrcrv_75/1000.0f, _rsc_thrcrv_100/1000.0f, (uint16_t)_rsc_slewrate.get());
}
...
void AP_MotorsHeli_Single::move_actuators(float roll_out, float pitch_out, float coll_in, float yaw_out)
{
    ...
    _main_rotor.set_collective(collective_out);
