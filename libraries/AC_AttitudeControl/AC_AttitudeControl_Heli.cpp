...
void AC_AttitudeControl_Heli::rate_bf_to_motor_roll_pitch(const Vector3f &rate_rads, float rate_roll_target_rads, float rate_pitch_target_rads)
{
    ...
    // calculate error
    rate_roll_error_rads = rate_roll_target_rads - _pid_rate_roll.notch_filter_gyro(rate_rads.x);
    rate_pitch_error_rads = rate_pitch_target_rads - _pid_rate_pitch.notch_filter_gyro(rate_rads.y);
...
float AC_AttitudeControl_Heli::rate_target_to_motor_yaw(float rate_yaw_actual_rads, float rate_target_rads)
{
    ...
    rate_error_rads  = rate_target_rads - _pid_rate_yaw.notch_filter_gyro(rate_yaw_actual_rads);
